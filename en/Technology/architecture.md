...
* Authentification/Authorisation is ensured by grouping different privileges into roles which then are assigned to
 defined users and in turn it ensures the confidentiality of patient data and security of the system.
